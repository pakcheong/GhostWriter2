...
export function extractUsage(
  ...
  const promptTokens =
    typeof u.promptTokens === 'number' ? u.promptTokens : estimateTokens(promptText, modelId);
  const completionTokens =
    typeof u.completionTokens === 'number' ? u.completionTokens : estimateTokens(completionText, modelId);
